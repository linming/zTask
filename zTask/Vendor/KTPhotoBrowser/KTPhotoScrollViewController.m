...
#define BUTTON_SAVEPHOTO 0
#define BUTTON_CANCEL 1

#define SHEET_DELETEPHOTO 101
#define SHEET_SAVEPHOTO 102
...
- (void)trashPhoto 
{
   UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:nil
    ...
    actionSheet.tag = SHEET_DELETEPHOTO;
...
- (void)exportPhoto
{
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:nil
                                               ...
                                               destructiveButtonTitle:nil
                                                    otherButtonTitles:nil];
    [actionSheet addButtonWithTitle:NSLocalizedString(@"Save Photo", @"Save Photo button text.")]; 
    [actionSheet addButtonWithTitle:NSLocalizedString(@"Cancel", @"Cancel button text.")];
    [actionSheet setCancelButtonIndex:1];
    actionSheet.tag = SHEET_SAVEPHOTO;
    [actionSheet showInView:[self view]];
...
{
    if (actionSheet.tag == SHEET_DELETEPHOTO) {
        if (buttonIndex == BUTTON_DELETEPHOTO) {
            [self deleteCurrentPhoto];
        }
    } else if (actionSheet.tag == SHEET_SAVEPHOTO) {
        if (buttonIndex == BUTTON_SAVEPHOTO) {
